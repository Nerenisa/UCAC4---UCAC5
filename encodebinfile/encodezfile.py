...
s = list(range(0, 648000000, 720000))       # wide 0.2 deg = 720000  (from 0 to 180 deg, step 0.2)
d = list(range(720000, 648720000, 720000))  
z = 0
for i, x in zip(s, d):
    files = []
    psql = ' '.join(('select * from "ucac4" where spd >=', str(i), 'and', 'spd <', str(x), 'order by ra;'))  # database query 
